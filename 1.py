...
title = Label(app, text='Wybór kadru', font='arial 30 bold', fg='#068481')
title.pack()
...
def openAndPut():
    ...
    if path:
        ...
        image_for_mask_multiplication = image_for_mask_multiplication.resize((960, 540), Image.ANTIALIAS)
...
image_area = Canvas(app, width=960, height=540, bg='#C8C8C8')
image_area.pack(pady=(10,0))


open_image = Button(app, width=20, text='Otwórz plik', font='none 12', command=openAndPut)
open_image.pack(pady=(10,5))

crop_area = Button(app, width=20,text='Wybierz obszar', font='none 12', command=select_area)
crop_area.pack(pady=(0,5))

show_area = Button(app, width=20, text='Pokaż obszar', font='none 12', command=show_mask)
show_area.pack(pady=(0,5))

save_image = Button(app, width=20, text='Zapisz plik', font='none 12', command=save_image)
save_image.pack()
